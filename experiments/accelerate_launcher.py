...
def main(config_args):
    ...
    config_args.accelerate_args.config_file = os.path.join(
        hydra_args.config_path, config_args.accelerate_args.config_file)
    accelerate_args_to_parse = prepare_args_for_parsing(config_args.accelerate_args)
    accelerate_args_to_parse.append(config_args.main_args.path)
